package com.aircon.shibagenerator.com.aircon.imgur.helpers;
...
import com.aircon.shibagenerator.R;
...
public class NotificationHelper {
    ...
    public void createUploadedNotification(ImageResponse response) {
        ...
        mBuilder.addAction(new NotificationCompat.Action(R.drawable.ic_share_white_24dp,
